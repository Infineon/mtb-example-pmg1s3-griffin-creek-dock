...
#define MP4247_REG_FB_RATIO                         (13u)

/* Macro to enable the Foxville power */
#define APP_FOXVILLE_POWER_ENABLE                   (1u)
...
/*******************************************************************************
 * PSOURCE controls for Port 1.
 ******************************************************************************/

/*
 * Macro used for enabling the VBus power provider path FET or external regulator
 * for Port-1.
 */
#define APP_VBUS_SRC_FET_ON_P1()                    \
{                                                   \
    Cy_App_BuckBoost_SetOutputPort1(true);          \
}

/*
 * Macro used for disabling the VBus power provider path FET or external regulator
 * for Port-1.
 */
 ...
 * for Port-2.
 */
#define APP_VBUS_SRC_FET_ON_P2()                        \
{                                                       \
    Cy_GPIO_Write(PB_VBUS_EN_PORT, PB_VBUS_EN_PIN, 1u); \
}
 ...
 * for Port-2.
 */
#define APP_VBUS_SRC_FET_OFF_P2()                       \
{                                                       \
    Cy_GPIO_Write(PB_VBUS_EN_PORT, PB_VBUS_EN_PIN, 0u); \
}
...
/* Wait period (in ms) for Goshen Ridge to boot-up. */
#define APP_GOSHEN_POWER_ON_WAIT_TIMER_PERIOD       (2500u)

/* Wait period (in ms) for Foxville to boot-up. */
#define APP_FOXVILLE_POWER_ON_WAIT_TIMER_PERIOD     (500u)

/*******************************************************************************
* DMC specific configurations 
*******************************************************************************/
...
#define COMPOSITE_VERSION_MAJOR_1                   (0)
