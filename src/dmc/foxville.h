/******************************************************************************
* File Name: foxville.h
*
* Description: Foxville implementation specific header file.
*
 ...
 *        various Foxville update operation
 * @param None
 *
 * @return cy_stc_app_dmc_update_opern_t Pointer to the cy_stc_app_dmc_update_opern_t
 */
const cy_stc_app_dmc_update_opern_t* get_fxvl_operation(void);
