 ...
 * @param ptrCdttCfg Pointer to the CDTT configuration.
 * @param ptrSecCfg Pointer to the security configuration table.
 * @param ptrAppCbk Pointer to the application callback structure.
